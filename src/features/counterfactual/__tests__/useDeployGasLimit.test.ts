...
import * as protocolKit from '@exsat/protocol-kit'
import * as protocolKitContracts from '@exsat/protocol-kit/dist/src/contracts/safeDeploymentContracts'
...
} from '@exsat/protocol-kit/dist/src/types'

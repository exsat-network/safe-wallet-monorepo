...
import { SafeProvider, SigningMethod } from '@exsat/protocol-kit'
import {
  generatePreValidatedSignature,
  isSafeMultisigTransactionResponse,
  sameString,
} from '@exsat/protocol-kit/dist/src/utils'
...
import { SAFE_FEATURES } from '@exsat/protocol-kit/dist/src/utils/safeVersions'

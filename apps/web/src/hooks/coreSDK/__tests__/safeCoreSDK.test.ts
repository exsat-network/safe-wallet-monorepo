...
import Safe from '@exsat/protocol-kit'
import {
  getProxyFactoryContract,
  getSafeContract,
} from '@exsat/protocol-kit/dist/src/contracts/safeDeploymentContracts'
...
jest.mock('@exsat/protocol-kit/dist/src/contracts/safeDeploymentContracts')
...
jest.mock('@exsat/protocol-kit', () => {
  return {
    ...jest.requireActual('@exsat/protocol-kit'),
    __esModule: true,
    default: {
      init: jest.fn(),
    },
